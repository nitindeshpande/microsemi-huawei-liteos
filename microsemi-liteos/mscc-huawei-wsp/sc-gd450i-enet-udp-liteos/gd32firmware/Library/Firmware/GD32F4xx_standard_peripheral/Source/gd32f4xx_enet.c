...
//enet_descriptors_struct  rxdesc_tab[ENET_RXBUF_NUM] __attribute__ ((aligned (4))) __attribute__ ((section (".tcm")));        /*!< ENET RxDMA descriptor */
enet_descriptors_struct  rxdesc_tab[ENET_RXBUF_NUM] __attribute__ ((aligned (4)));

//enet_descriptors_struct  txdesc_tab[ENET_TXBUF_NUM] __attribute__ ((aligned (4))) __attribute__ ((section (".tcm")));        /*!< ENET TxDMA descriptor */
enet_descriptors_struct  txdesc_tab[ENET_TXBUF_NUM] __attribute__ ((aligned (4)));

//uint8_t rx_buff[ENET_RXBUF_NUM][ENET_RXBUF_SIZE] __attribute__ ((aligned (4))) __attribute__ ((section (".tcm")));           /*!< ENET receive buffer */
uint8_t rx_buff[ENET_RXBUF_NUM][ENET_RXBUF_SIZE] __attribute__ ((aligned (4)));

//uint8_t tx_buff[ENET_TXBUF_NUM][ENET_TXBUF_SIZE] __attribute__ ((aligned (4))) __attribute__ ((section (".tcm")));           /*!< ENET transmit buffer */
uint8_t tx_buff[ENET_TXBUF_NUM][ENET_TXBUF_SIZE] __attribute__ ((aligned (4)));
#endif /* __CC_ARM */

/* global transmit and receive descriptors pointers */
//enet_descriptors_struct  *dma_current_txdesc __attribute__ ((aligned (4))) __attribute__ ((section (".tcm")));
//enet_descriptors_struct  *dma_current_rxdesc __attribute__ ((aligned (4))) __attribute__ ((section (".tcm")));

enet_descriptors_struct  *dma_current_txdesc __attribute__ ((aligned (4)));
enet_descriptors_struct  *dma_current_rxdesc __attribute__ ((aligned (4)));

/* structure pointer of ptp descriptor for normal mode */
//enet_descriptors_struct  *dma_current_ptp_txdesc __attribute__ ((aligned (4))) __attribute__ ((section (".tcm"))) = NULL ;
//enet_descriptors_struct  *dma_current_ptp_rxdesc __attribute__ ((aligned (4))) __attribute__ ((section (".tcm"))) = NULL ;

//enet_descriptors_struct  *dma_current_ptp_txdesc __attribute__ ((section (".tcm"))) = NULL ;
//enet_descriptors_struct  *dma_current_ptp_rxdesc __attribute__ ((section (".tcm"))) = NULL ;

enet_descriptors_struct  *dma_current_ptp_txdesc __attribute__ ((aligned (4))) = NULL ;
enet_descriptors_struct  *dma_current_ptp_rxdesc __attribute__ ((aligned (4))) = NULL ;
