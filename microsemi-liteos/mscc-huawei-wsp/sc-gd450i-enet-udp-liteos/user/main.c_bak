/*
 MSCC Update:
 This project is an example showcasing that the Microsemi's SoftConsole works 
 successfully to build, download and step debug the LiteOS based project 
 on GD450i board.

 This project blinks the LED3 on board and 
*/
...
LITE_OS_SEC_TEXT VOID LOS_BoadExampleTskfunc(VOID)
{
    while (1)
    {
        ...
        LOS_EvbUartWriteStr("SoftConsole running on GD450 board\n");
        LOS_TaskDelay(500);
